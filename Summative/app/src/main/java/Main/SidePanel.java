...
/**
 * Represents the side panel in the game.
 */
public class SidePanel extends JPanel {
    ...
    /**
     * Gets the shop toggle button.
     * 
     * @return The shop toggle button.
     */
    ...
    public void importResources() {
        ...
        startLabelIcon = new ImageIcon(new ImageIcon("Summative/app/src/main/java/Resources/startLabel.png").getImage().getScaledInstance(160, (int) (1 / 4.0 * 240), Image.SCALE_SMOOTH));
        gameOverLabelIcon = new ImageIcon(new ImageIcon("Summative/app/src/main/java/Resources/gameOverLabel.png").getImage().getScaledInstance(160, (int) (1 / 4.0 * 240), Image.SCALE_SMOOTH));
