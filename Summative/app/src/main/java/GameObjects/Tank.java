...
public class Tank extends Hooman{
    ...
    private static Image[] importSprites() {
        ...
        try{
            InputStream inputStream = Archer.class.getResourceAsStream("/Resources/tank.png");
            sprites[0] = ImageIO.read(inputStream);

            inputStream = Hooman.class.getResourceAsStream("/Resources/tankTurret.png");
            sprites[1] = ImageIO.read(inputStream).getScaledInstance(WEAPON_SIZE,WEAPON_SIZE,Image.SCALE_AREA_AVERAGING);

            inputStream = Hooman.class.getResourceAsStream("/Resources/tankShell.png");
