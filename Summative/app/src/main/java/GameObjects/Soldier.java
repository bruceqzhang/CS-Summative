...
public class Soldier extends Hooman{
    ...
    private static Image[] importSprites() {
        ...
        try{
            InputStream inputStream = Archer.class.getResourceAsStream("/Resources/soldier.png");
            sprites[0] = ImageIO.read(inputStream);

            inputStream = Hooman.class.getResourceAsStream("/Resources/soldierGun.png");
            sprites[1] = ImageIO.read(inputStream).getScaledInstance(WEAPON_SIZE,WEAPON_SIZE*3/2,Image.SCALE_AREA_AVERAGING);

            inputStream = Hooman.class.getResourceAsStream("/Resources/soldierBullet.png");
